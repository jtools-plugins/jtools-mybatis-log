...
class SettingPanel(val project: Project, val tempProps: TempProps, val updated: (TempProps) -> Unit = {}) : JPanel(),
    ...
    init {
        ...
        this.add(JPanel(BorderLayout()).apply {
            ...
            this.add(JPanel(java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 0, 0)).apply {
            ...
            decorator.setAddAction {
                ...
                val popup = JBPopupFactory.getInstance()
                    .createListPopup(object : BaseListPopupStep<String>(
                        "选择类型 (Select Type)",
                        listOf("添加包 (Add Package)", "添加包 (从类导入/From Class)", "添加类 (Add Class)", "添加自定义 (Add Custom)")
                    ) {
                            ...
                            ApplicationManager.getApplication().invokeLater {
                                if (selectedValue == "添加包 (Add Package)") {
                                    ...
                                    if (selectedClass != null) {
                                        ...
                                        val packageName = (selectedClass.containingFile as? com.intellij.psi.PsiClassOwner)?.packageName
